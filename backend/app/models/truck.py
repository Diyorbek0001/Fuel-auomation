...
class Truck(Base):
    ...
    previous_fuel_percent: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    ...
    last_samsara_update_at: Mapped[Optional[datetime]] = mapped_column(DateTime(timezone=True), nullable=True)
