...
class FuelDispatch(Base):
    ...
    pre_alert_sent_at: Mapped[Optional[datetime]] = mapped_column(DateTime(timezone=True), nullable=True)
    final_alert_sent_at: Mapped[Optional[datetime]] = mapped_column(DateTime(timezone=True), nullable=True)
    arrived_alert_sent_at: Mapped[Optional[datetime]] = mapped_column(DateTime(timezone=True), nullable=True)
    missed_alert_sent_at: Mapped[Optional[datetime]] = mapped_column(DateTime(timezone=True), nullable=True)
    last_distance_to_station_miles: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    minimum_distance_to_station_miles: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
